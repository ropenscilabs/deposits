...
downloaded. All deposits begin with metadata, with the actual data upload only
possible once the initial metadata has been specified and uploaded.
Understanding these metadata structures is thus the essential first step to
using `deposits`.

As indicated in [the main
README](https://docs.ropensci.org/deposits/reference/depositsClient.html#methods),
the `deposits` workflow includes three types of metadata:

...
along with detailed descriptions of the kind of metadata accepted by a
`deposits` client.
...
function](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-new-).
...
which creates a new client. The [`$deposit_new()`
function](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-new-)

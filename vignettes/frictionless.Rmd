...
on the deposits service. The `path` argument passed to that method can either
be the path to the entire data directly, in which case all files which have
been modified will be uploaded, or it can specify the path to the single

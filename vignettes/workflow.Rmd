...
also be passed. However, once a "datapackage.json" file exists, the deposits
client can be updated by calling [the `deposit_update()`
method](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-update-).
This has exactly the same effect as
[`deposit_fill_metadata()`](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-fill-metadata-)
for deposits which have not been initiated on the remote service, but has
additional effects after that point, as demonstrated in the subsequent section.

The
[`deposit_fill_metadata()`](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-fill-metadata-)
should be used only to initiate a client with metadata. Once a local
"datapackage.json" file exists, all metadata modification should be done by
directly modifying that file and calling [the `deposit_update()`
method](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-update-).
...
the remote deposits service, the The [`deposit_update()`
method](https://docs.ropensci.org/deposits/reference/depositsClient.html#method-deposit-update-)

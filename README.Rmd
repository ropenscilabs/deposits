...
r-universe](https://ropensci.r-universe.dev), and using `install.package()`:
...
[`zenodo`](https://zenodo.org) offers a "sandbox" environment for testing,
which offers an ideal environment for testing the functionality of this
package.

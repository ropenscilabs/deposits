...
function, for which the first parameter must be given to specify the service
with which the client will connect:
...
A `deposits` client offers the following additional functions, listed here with
...
"Metadata" vignette describes processes to specify deposit metadata with a
`deposits` client.

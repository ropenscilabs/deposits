structure(list(method = "PUT", url = "api/articles/23177615", 
    status_code = 205L, headers = structure(list(date = "Thu, 25 May 2023 09:12:59 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/23177615", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23177615\", \"warnings\": []}")), class = "httr2_response")

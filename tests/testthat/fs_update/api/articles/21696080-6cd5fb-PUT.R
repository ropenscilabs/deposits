structure(list(method = "PUT", url = "api/articles/21696080", 
    status_code = 205L, headers = structure(list(date = "Thu, 08 Dec 2022 14:06:04 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/21696080", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21696080\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "PUT", url = "api/articles/21369876", 
    status_code = 205L, headers = structure(list(date = "Thu, 20 Oct 2022 10:20:51 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21369876\", \"warnings\": []}")), class = "httr2_response")

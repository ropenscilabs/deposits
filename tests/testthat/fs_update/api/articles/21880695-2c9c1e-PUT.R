structure(list(method = "PUT", url = "api/articles/21880695", 
    status_code = 205L, headers = structure(list(date = "Thu, 12 Jan 2023 13:55:47 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/21880695", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21880695\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "PUT", url = "api/articles/22665841", 
    status_code = 205L, headers = structure(list(date = "Thu, 20 Apr 2023 14:49:20 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22665841", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22665841\", \"warnings\": []}")), class = "httr2_response")

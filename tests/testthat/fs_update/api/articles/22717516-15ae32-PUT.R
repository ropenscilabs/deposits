structure(list(method = "PUT", url = "api/articles/22717516", 
    status_code = 205L, headers = structure(list(date = "Fri, 28 Apr 2023 12:13:20 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22717516", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22717516\", \"warnings\": []}")), class = "httr2_response")

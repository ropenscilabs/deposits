structure(list(method = "PUT", url = "api/articles/21805392", 
    status_code = 205L, headers = structure(list(date = "Tue, 03 Jan 2023 09:45:19 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/21805392", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21805392\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "PUT", url = "api/articles/22666435", 
    status_code = 205L, headers = structure(list(date = "Thu, 20 Apr 2023 16:23:40 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22666435", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22666435\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "PUT", url = "api/articles/22318066", 
    status_code = 205L, headers = structure(list(date = "Wed, 22 Mar 2023 15:57:32 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22318066", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22318066\", \"warnings\": []}")), class = "httr2_response")

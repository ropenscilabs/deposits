structure(list(method = "PUT", url = "api/articles/22294264", 
    status_code = 205L, headers = structure(list(date = "Fri, 17 Mar 2023 14:35:27 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22294264", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22294264\", \"warnings\": []}")), class = "httr2_response")

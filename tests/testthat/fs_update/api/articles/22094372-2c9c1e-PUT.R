structure(list(method = "PUT", url = "api/articles/22094372", 
    status_code = 205L, headers = structure(list(date = "Tue, 14 Feb 2023 15:20:09 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22094372", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22094372\", \"warnings\": []}")), class = "httr2_response")

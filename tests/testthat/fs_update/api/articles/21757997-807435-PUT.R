structure(list(method = "PUT", url = "api/articles/21757997", 
    status_code = 205L, headers = structure(list(date = "Tue, 20 Dec 2022 14:59:15 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/21757997", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21757997\", \"warnings\": []}")), class = "httr2_response")

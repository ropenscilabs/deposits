structure(list(method = "PUT", url = "api/articles/22294396", 
    status_code = 205L, headers = structure(list(date = "Fri, 17 Mar 2023 14:58:53 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22294396", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22294396\", \"warnings\": []}")), class = "httr2_response")

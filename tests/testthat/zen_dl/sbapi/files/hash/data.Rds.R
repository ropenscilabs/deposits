structure(list(method = "GET", url = "sbapi/files/hash/data.Rds", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Tue, 03 Jan 2023 17:47:31 GMT", `Content-Type` = "application/octet-stream", 
        ...
        `X-XSS-Protection` = "1; mode=block", `Last-Modified` = "Tue, 03 Jan 2023 17:47:30 GMT", 
        ETag = "\"md5:3ac485c9229cb2bd9f65bc0c3dfb2bb6\"", `X-RateLimit-Limit` = "100", 
        `X-RateLimit-Remaining` = "88", `X-RateLimit-Reset` = "1672768112", 

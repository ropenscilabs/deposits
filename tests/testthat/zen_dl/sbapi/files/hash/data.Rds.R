structure(list(method = "GET", url = "sbapi/files/hash/data.Rds", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Thu, 08 Dec 2022 14:06:11 GMT", `Content-Type` = "application/octet-stream", 
        ...
        `X-XSS-Protection` = "1; mode=block", `Last-Modified` = "Thu, 08 Dec 2022 14:06:10 GMT", 
        ETag = "\"md5:3ac485c9229cb2bd9f65bc0c3dfb2bb6\"", `X-RateLimit-Limit` = "100", 
        `X-RateLimit-Remaining` = "88", `X-RateLimit-Reset` = "1670508432", 

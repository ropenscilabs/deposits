structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Mon, 12 Jun 2023 15:02:24 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/23502066", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 23502066, \"location\": \"api/articles/23502066\", \"warnings\": []}")), class = "httr2_response")

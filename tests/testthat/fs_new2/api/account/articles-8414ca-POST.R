structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Fri, 26 May 2023 13:11:42 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/23220395", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 23220395, \"location\": \"api/articles/23220395\", \"warnings\": []}")), class = "httr2_response")

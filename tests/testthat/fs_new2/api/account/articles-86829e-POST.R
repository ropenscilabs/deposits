structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 25 May 2023 09:12:56 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/23177612", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 23177612, \"location\": \"api/articles/23177612\", \"warnings\": []}")), class = "httr2_response")

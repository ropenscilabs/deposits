structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 16:23:38 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/22666432", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 22666432, \"location\": \"api/articles/22666432\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Fri, 28 Apr 2023 12:13:11 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/22717513", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 22717513, \"location\": \"api/articles/22717513\", \"warnings\": []}")), class = "httr2_response")

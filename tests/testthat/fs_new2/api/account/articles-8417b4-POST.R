structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Wed, 14 Jun 2023 10:56:59 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/23514885", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 23514885, \"location\": \"api/articles/23514885\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 15 Jun 2023 09:26:17 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/23522484", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 23522484, \"location\": \"api/articles/23522484\", \"warnings\": []}")), class = "httr2_response")

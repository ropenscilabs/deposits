structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 14:48:48 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/22665889", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 22665889, \"location\": \"api/articles/22665889\", \"warnings\": []}")), class = "httr2_response")

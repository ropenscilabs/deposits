structure(list(method = "PUT", url = "api/articles/23522487", 
    status_code = 205L, headers = structure(list(date = "Thu, 15 Jun 2023 09:26:32 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23522487\", \"warnings\": []}")), class = "httr2_response")

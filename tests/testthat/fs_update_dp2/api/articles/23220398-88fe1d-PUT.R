structure(list(method = "PUT", url = "api/articles/23220398", 
    status_code = 205L, headers = structure(list(date = "Fri, 26 May 2023 13:11:56 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/23220398", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23220398\", \"warnings\": []}")), class = "httr2_response")

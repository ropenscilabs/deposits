structure(list(method = "PUT", url = "api/articles/22788806", 
    status_code = 205L, headers = structure(list(date = "Tue, 09 May 2023 16:32:43 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22788806", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22788806\", \"warnings\": []}")), class = "httr2_response")

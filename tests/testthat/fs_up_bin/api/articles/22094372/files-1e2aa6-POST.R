structure(list(method = "POST", url = "api/articles/22094372/files", 
    status_code = 201L, headers = structure(list(date = "Tue, 14 Feb 2023 15:20:39 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22094372/files/39255464\"}")), class = "httr2_response")

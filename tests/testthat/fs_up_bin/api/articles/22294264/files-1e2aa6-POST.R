structure(list(method = "POST", url = "api/articles/22294264/files", 
    status_code = 201L, headers = structure(list(date = "Fri, 17 Mar 2023 14:35:32 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22294264/files/39646843\"}")), class = "httr2_response")

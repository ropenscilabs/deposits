structure(list(method = "POST", url = "api/articles/22294396/files", 
    status_code = 201L, headers = structure(list(date = "Fri, 17 Mar 2023 14:58:59 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22294396/files/39646957\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/22094399/files", 
    status_code = 201L, headers = structure(list(date = "Tue, 14 Feb 2023 15:31:04 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22094399/files/39255527\"}")), class = "httr2_response")

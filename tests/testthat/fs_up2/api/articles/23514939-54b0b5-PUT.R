structure(list(method = "PUT", url = "api/articles/23514939", 
    status_code = 205L, headers = structure(list(date = "Wed, 14 Jun 2023 11:33:57 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/23514939", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23514939\", \"warnings\": []}")), class = "httr2_response")

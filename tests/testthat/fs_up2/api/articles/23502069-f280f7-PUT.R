structure(list(method = "PUT", url = "api/articles/23502069", 
    status_code = 205L, headers = structure(list(date = "Mon, 12 Jun 2023 15:02:35 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/23502069", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23502069\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/23514939/files", 
    status_code = 201L, headers = structure(list(date = "Wed, 14 Jun 2023 11:33:46 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23514939/files/41239026\"}")), class = "httr2_response")

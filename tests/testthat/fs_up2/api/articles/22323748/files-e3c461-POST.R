structure(list(method = "POST", url = "api/articles/22323748/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 23 Mar 2023 10:22:51 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22323748/files/39714244\"}")), class = "httr2_response")

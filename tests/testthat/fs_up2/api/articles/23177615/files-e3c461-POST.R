structure(list(method = "POST", url = "api/articles/23177615/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 25 May 2023 09:13:04 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23177615/files/40876412\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/22323991/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 23 Mar 2023 11:00:54 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22323991/files/39714577\"}")), class = "httr2_response")

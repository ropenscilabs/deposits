structure(list(method = "POST", url = "api/articles/22318066/files", 
    status_code = 201L, headers = structure(list(date = "Wed, 22 Mar 2023 15:57:35 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22318066/files/39705736\"}")), class = "httr2_response")

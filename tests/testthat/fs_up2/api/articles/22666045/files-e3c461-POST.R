structure(list(method = "POST", url = "api/articles/22666045/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 15:12:33 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22666045/files/40232977\"}")), class = "httr2_response")

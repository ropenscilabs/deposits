structure(list(method = "POST", url = "api/articles/23522487/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 15 Jun 2023 09:26:27 GMT", 
        `content-type` = "application/json", `content-length` = "84", 
        location = "api/articles/23522487/files/41251092", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23522487/files/41251092\"}")), class = "httr2_response")

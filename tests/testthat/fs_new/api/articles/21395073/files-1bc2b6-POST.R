structure(list(method = "POST", url = "api/articles/21395073/files", 
    status_code = 201L, headers = structure(list(date = "Tue, 25 Oct 2022 14:15:19 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21395073/files/37984386\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Mon, 12 Jun 2023 15:02:26 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 23502069, \"location\": \"api/articles/23502069\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 14:45:01 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 22665841, \"location\": \"api/articles/22665841\", \"warnings\": []}")), class = "httr2_response")

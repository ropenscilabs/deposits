structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Wed, 22 Mar 2023 15:57:31 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 22318066, \"location\": \"api/articles/22318066\", \"warnings\": []}")), class = "httr2_response")

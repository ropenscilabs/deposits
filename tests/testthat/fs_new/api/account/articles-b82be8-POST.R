structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Tue, 03 Jan 2023 09:45:18 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 21805392, \"location\": \"api/articles/21805392\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Tue, 20 Dec 2022 14:56:19 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 21757997, \"location\": \"api/articles/21757997\", \"warnings\": []}")), class = "httr2_response")

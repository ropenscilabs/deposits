structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 12 Jan 2023 13:55:46 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 21880695, \"location\": \"api/articles/21880695\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Tue, 03 Jan 2023 17:47:23 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/21807069", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 21807069, \"location\": \"api/articles/21807069\", \"warnings\": []}")), class = "httr2_response")

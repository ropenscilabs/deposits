structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 06 Oct 2022 13:15:03 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 21287262, \"location\": \"api/articles/21287262\", \"warnings\": []}")), class = "httr2_response")

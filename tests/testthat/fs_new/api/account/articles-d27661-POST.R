structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Fri, 20 May 2022 11:34:56 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles19802839", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 19802839, \"location\": \"api/articles19802839\", \"warnings\": []}")), class = "httr2_response")

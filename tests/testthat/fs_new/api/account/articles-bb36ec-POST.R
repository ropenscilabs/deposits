structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Fri, 26 May 2023 13:11:44 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 23220398, \"location\": \"api/articles/23220398\", \"warnings\": []}")), class = "httr2_response")

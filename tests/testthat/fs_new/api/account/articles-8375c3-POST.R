structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Mon, 23 May 2022 09:33:27 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles19824289", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 19824289, \"location\": \"api/articles19824289\", \"warnings\": []}")), class = "httr2_response")

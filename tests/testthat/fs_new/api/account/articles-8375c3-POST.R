structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Mon, 30 May 2022 14:54:05 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/19928660", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 19928660, \"location\": \"api/articles/19928660\", \"warnings\": []}")), class = "httr2_response")

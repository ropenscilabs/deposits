structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Tue, 09 May 2023 16:24:16 GMT", 
    ...
    body = charToRaw("{\"entity_id\": 22788767, \"location\": \"api/articles/22788767\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 15:12:30 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles/22666045", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 22666045, \"location\": \"api/articles/22666045\", \"warnings\": []}")), class = "httr2_response")

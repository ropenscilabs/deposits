structure(list(method = "POST", url = "api/account/articles", 
    status_code = 201L, headers = structure(list(date = "Wed, 18 May 2022 11:03:33 GMT", 
        `content-type` = "application/json", `content-length` = "108", 
        location = "api/articles19786306", server = "nginx", 
    ...
    body = charToRaw("{\"entity_id\": 19786306, \"location\": \"api/articles19786306\", \"warnings\": []}")), class = "httr2_response")

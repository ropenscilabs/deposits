structure(list(method = "POST", url = "api/articles/21533469/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 10 Nov 2022 11:15:52 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21533469/files/38169006\"}")), class = "httr2_response")

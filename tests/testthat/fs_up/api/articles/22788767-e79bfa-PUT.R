structure(list(method = "PUT", url = "api/articles/22788767", 
    status_code = 205L, headers = structure(list(date = "Tue, 09 May 2023 16:24:22 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22788767", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22788767\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/22788494/files", 
    status_code = 201L, headers = structure(list(date = "Tue, 09 May 2023 15:35:55 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22788494/files/40497149\"}")), class = "httr2_response")

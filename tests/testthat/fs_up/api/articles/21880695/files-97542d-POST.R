structure(list(method = "POST", url = "api/articles/21880695/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 12 Jan 2023 13:55:49 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21880695/files/38816940\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/23220398/files", 
    status_code = 201L, headers = structure(list(date = "Fri, 26 May 2023 13:11:49 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23220398/files/40933352\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/23502069/files", 
    status_code = 201L, headers = structure(list(date = "Mon, 12 Jun 2023 15:02:31 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/23502069/files/41219379\"}")), class = "httr2_response")

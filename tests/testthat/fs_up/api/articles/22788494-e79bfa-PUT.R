structure(list(method = "PUT", url = "api/articles/22788494", 
    status_code = 205L, headers = structure(list(date = "Tue, 09 May 2023 15:35:57 GMT", 
        `content-type` = "application/json", `content-length` = "85", 
        location = "api/articles/22788494", server = "nginx", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22788494\", \"warnings\": []}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/22788806/files", 
    status_code = 201L, headers = structure(list(date = "Tue, 09 May 2023 16:32:37 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22788806/files/40497569\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/22665841/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 14:49:26 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22665841/files/40232800\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/21369876/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Oct 2022 10:20:52 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21369876/files/37923942\"}")), class = "httr2_response")

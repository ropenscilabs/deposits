structure(list(method = "POST", url = "api/articles/22788767/files", 
    status_code = 201L, headers = structure(list(date = "Tue, 09 May 2023 16:24:20 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22788767/files/40497509\"}")), class = "httr2_response")

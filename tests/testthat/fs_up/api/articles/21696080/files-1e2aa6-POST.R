structure(list(method = "POST", url = "api/articles/21696080/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 08 Dec 2022 14:06:04 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21696080/files/38480336\"}")), class = "httr2_response")

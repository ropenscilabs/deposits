structure(list(method = "POST", url = "api/articles/22717516/files", 
    status_code = 201L, headers = structure(list(date = "Fri, 28 Apr 2023 12:13:24 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22717516/files/40349086\"}")), class = "httr2_response")

structure(list(method = "POST", url = "api/articles/22666435/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 20 Apr 2023 16:23:41 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/22666435/files/40233574\"}")), class = "httr2_response")

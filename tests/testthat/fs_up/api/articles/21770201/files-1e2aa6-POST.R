structure(list(method = "POST", url = "api/articles/21770201/files", 
    status_code = 201L, headers = structure(list(date = "Thu, 22 Dec 2022 13:57:09 GMT", 
    ...
    body = charToRaw("{\"location\": \"api/articles/21770201/files/38632343\"}")), class = "httr2_response")
